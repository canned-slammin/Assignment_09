                ...
                for disc in lst_Inventory:
                    ...
                    for track in tracks:
                        if track is not None:
                            entry = '{},{}'.format(cd_id,track.get_record())
                            file.write(entry)
            print('file saved!')
        ...
        try:
            with open(file_name[0], 'r') as file:
                for line in file:
                    ...
                    disc = DC.CD(data[0], data[1], data[2])
                    lst_Inventory.append(disc)
                print('disc loaded')
...
class ScreenIO:
    ...
    def get_track_id():
        """
        function to get 'ID' (position) of single track.
        

        Returns
        -------
        trkID : integer
            position of track for use as ID
