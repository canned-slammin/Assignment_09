...
class Track():
    ...
    """
    # -- Constructor -- #
    def __init__(self, position:int, title:str, length:str):
        """
        Set position, title, and length of track
        """
        try:
            ...
            print("Error occured during track initialization:")
            print(e)
...
class CD:
    ...
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str) -> None:
        """Set ID, Title, Artist, and Tracks of a new CD Object"""
        #    -- Attributes  -- #
        try:
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        try:
            ...
            print('error occurred while deleting track: ')
            print(e)
